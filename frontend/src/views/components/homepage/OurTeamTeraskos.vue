...
export default {
  ...
  data() {
    return {
      ...
      fasility:[],
      foto:{
        ke1: require("@/assets/img/icon/foto/M. Rakhmat Setiawan.png"),
        ke2: require("@/assets/img/icon/foto/Safitri Nur Wulandari.png")
      }
    };
  },
  computed:{},
...
.our-team:hover .team-content{ border: 2px dotted #0c8744; }
.our-team .team-info{
    width: 100%;
    color: #464646;
    position: absolute;
...
.our-team:hover .title{ color: #0c8744; }
.our-team .post{
    display: block;
    font-size: 14px;
    color: #464646;
