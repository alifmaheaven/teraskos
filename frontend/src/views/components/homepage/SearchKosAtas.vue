<template>
  <div class="card">
    <div class="card-body">
      <div class="col-12"><h4>hello,</h4></div>
      <div class="col-12"><h4>want reservation a kos kosan ?</h4></div>
        ...
        <form>
          <div class="row">
              ...
              >
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    :class="{ 'is-invalid': errors[0] && invalid }"
            ...
            <div class="col-3">
              <ValidationProvider
                name="Check-Out"
                rules="max:12|min:9|noMoreSpace"
                v-slot="{ errors, valid, invalid }"
              >
                <div class="form-group">
